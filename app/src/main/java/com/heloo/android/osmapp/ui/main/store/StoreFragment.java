...
//            }
//            for (int j = 0; j < shopListBO.list.get(i).typeGoodsMoels.size(); j++) {
//                LinkBean.Item item = new LinkBean.Item();
//                item.setName(shopListBO.list.get(i).typeGoodsMoels.get(j).name);
//                item.setChildList(shopListBO.list.get(i).typeGoodsMoels.get(j).goodsMoels);
//                linkBean.itemS.add(item);
//            }
//        }
//        if (StringUtils.isEmpty(linkBean.itemS.get(0).getName())) {
...
//                    if (StringUtils.isEmpty(rAdapter.getmData().get(index).getName())) {
//                        viewBinding.tvHeader.setVisibility(View.GONE);
//                    } else {
//                        viewBinding.tvHeader.setVisibility(View.VISIBLE);
//                    }
