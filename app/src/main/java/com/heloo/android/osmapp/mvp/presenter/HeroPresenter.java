 ...
 * Describe:
 */
public class HeroPresenter extends BasePresenterImpl<HeroContract.View>
        implements HeroContract.Presenter{

    @Override
    public void getData(String token, String type) {
        HttpInterfaceIml.getHeroList(token,type).subscribe(new Subscriber<ResponseBody>() {
            @Override
